...
if __name__ == '__main__':
    ...
    ax[0, 0].plot(x, order_list[0], "b-",lw=2, alpha=0.7)
    ax[0, 0].set_title("spot_1")
    ax[0, 1].plot(x, order_list[1], "b-",lw=2, alpha=0.7)
    ax[0, 1].set_title("spot_2")
    ax[0, 2].plot(x, order_list[2], "b-",lw=2, alpha=0.7)
    ax[0, 2].set_title("spot_3")
    ax[1, 0].plot(x, order_list[3], "b-",lw=2, alpha=0.7)
    ax[1, 0].set_title("spot_4")
    ax[1, 1].plot(x, order_list[4], "b-",lw=2, alpha=0.7)
    ax[1, 1].set_title("spot_5")
    ax[1, 2].plot(x, order_list[5], "b-",lw=2, alpha=0.7)
    ax[1, 2].set_title("spot_6")
    fig.text(0.5, 0.04, 'Spot name', ha='center')
    fig.text(0.04, 0.5, 'KNN accuracy', va='center', rotation='vertical')
    plt.setp(ax, xticks= x , xticklabels = x_label, ylim = ([0.3, 1.0]))
    plt.show()
